...
COMPANIONWAY_TO_OILY_CORRIDOR__E_LEVEL = room
{
	nam = "COMPANIONWAY TO OILY CORRIDOR - 'E' LEVEL",
	dsc = [[----------------------------------------------------------------
...
EQUIPMENT_MAINTENANCE_AREA__C_LEVEL = room
{
	nam = "EQUIPMENT MAINTENANCE AREA - 'C' LEVEL",
	dsc = [[----------------------------------------------------------------
...
NARCISSUS__OUTER_SPACE = room
{
	nam = "NARCISSUS - OUTER SPACE",
	dsc = [[----------------------------------------------------------------
...
CORRIDOR__A_LEVEL = room
{
	nam = "CORRIDOR - 'A' LEVEL",
	dsc = [[----------------------------------------------------------------
...
ENGINE_ROOM_CUBICLE = room
{
	nam = "ENGINE ROOM CUBICLE",
	dsc = [[----------------------------------------------------------------
...
SPACE_SUIT_LOCKER = room
{
	nam = "SPACE SUIT LOCKER",
	dsc = [[----------------------------------------------------------------
...
COMPUTER_ROOM_ANNEX = room
{
	nam = "COMPUTER ROOM ANNEX",
	dsc = [[----------------------------------------------------------------
...
LANDING_LEG__NIGHT = room
{
	nam = "LANDING LEG - NIGHT",
	dsc = [[----------------------------------------------------------------
...
FOOD_LOCKER_NUMBER_6__B_LEVEL = room
{
	nam = "FOOD LOCKER NUMBER 6 - 'B' LEVEL",
	dsc = [[----------------------------------------------------------------
...
CORRIDOR_TO_BRIDGE = room
{
	nam = "CORRIDOR TO BRIDGE",
	dsc = [[----------------------------------------------------------------
...
ENTRANCE_TO_DERELICT__SUNSET = room
{
	nam = "ENTRANCE TO DERELICT - SUNSET",
	dsc = [[----------------------------------------------------------------
...
CORRIDOR_OUTSIDE_IMFIRMARY_WINDOW = room
{
	nam = "CORRIDOR OUTSIDE IMFIRMARY WINDOW",
	dsc = [[----------------------------------------------------------------
...
SECOND_LEVEL__C_DECK = room
{
	nam = "SECOND LEVEL - 'C' DECK",
	dsc = [[----------------------------------------------------------------
...
PASSAGEWAY_NEAR_AIR_LOCK__B_LEVEL = room
{
	nam = "PASSAGEWAY NEAR AIR LOCK - 'B' LEVEL",
	dsc = [[----------------------------------------------------------------
...
CORRIDOR_TO_BRIDGE__A_LEVEL = room
{
	nam = "CORRIDOR TO BRIDGE - 'A' LEVEL",
	dsc = [[----------------------------------------------------------------
...
NOSTROMO__OUTER_SPACE = room
{
	nam = "NOSTROMO - OUTER SPACE",
	dsc = [[----------------------------------------------------------------
...
OILY_CORRIDOR__C_DECK = room
{
	nam = "OILY CORRIDOR - 'C' DECK",
	dsc = [[----------------------------------------------------------------
...
FOOR_LOCKER_NUMBER_6 = room
{
	nam = "FOOR LOCKER NUMBER 6",
	dsc = [[----------------------------------------------------------------
...
PASSAGEWAY__B_DECK = room
{
	nam = "PASSAGEWAY - 'B' DECK",
	dsc = [[----------------------------------------------------------------
...
PASSAGEWAY__C_LEVEL = room
{
	nam = "PASSAGEWAY - 'C' LEVEL",
	dsc = [[----------------------------------------------------------------
...
UNDERCARRIAGE_MAINTENANCE_ROOM_NUMBER_4 = room
{
	nam = "UNDERCARRIAGE MAINTENANCE ROOM NUMBER 4",
	dsc = [[----------------------------------------------------------------
...
_B_LEVEL__CORRIDOR_LEADING_TO_NARCISSUS = room
{
	nam = "'B' LEVEL - CORRIDOR LEADING TO NARCISSUS",
	dsc = [[----------------------------------------------------------------
...
STARBOARD_AIR_LOCK__VESTIBULE = room
{
	nam = "STARBOARD AIR LOCK - VESTIBULE",
	dsc = [[----------------------------------------------------------------
...
_A_TO_B_LEVELS__COMPANIONWAY = room
{
	nam = "'A' TO 'B' LEVELS - COMPANIONWAY",
	dsc = [[----------------------------------------------------------------
...
FOOD_STORAGE_LOCKER_NUMBER_12__B_LEVEL = room
{
	nam = "FOOD STORAGE LOCKER NUMBER 12 - 'B' LEVEL",
	dsc = [[----------------------------------------------------------------
...
_B_LEVEL__CORRIDOR_LEADING_TO_AIR_LOCK = room
{
	nam = "'B' LEVEL - CORRIDOR LEADING TO AIR LOCK",
	dsc = [[----------------------------------------------------------------
...
FOOD_LOCKER_NUMBER_12 = room
{
	nam = "FOOD LOCKER NUMBER 12",
	dsc = [[----------------------------------------------------------------
...
AIR_SHAFT_DOUBLE_TIERED_PASSAGEWAY = room
{
	nam = "AIR SHAFT DOUBLE-TIERED PASSAGEWAY",
	dsc = [[----------------------------------------------------------------
...
AIR_SHAFT__DOUBLE_TIERED_PASSAGEWAY = room
{
	nam = "AIR SHAFT - DOUBLE-TIERED PASSAGEWAY",
	dsc = [[----------------------------------------------------------------
...
ASH_S_BLISTER__DAY = room
{
	nam = "ASH'S BLISTER - DAY",
	dsc = [[----------------------------------------------------------------
...
PASSAGEWAY_NEAR_AIR_LOCK = room
{
	nam = "PASSAGEWAY NEAR AIR LOCK",
	dsc = [[----------------------------------------------------------------
...
NOSTROMO_AND_REFINERY_APPROACHING_THE = room
{
	nam = "NOSTROMO AND REFINERY APPROACHING THE",
	dsc = [[----------------------------------------------------------------
        STAR/PLANET SYSTEM
...
STRUCTURE_OPENING = room
{
	nam = "STRUCTURE OPENING",
	dsc = [[----------------------------------------------------------------
...
AIR_LOCK__NARCISSUS = room
{
	nam = "AIR LOCK - NARCISSUS",
	dsc = [[----------------------------------------------------------------
...
_B_LEVEL__COMPANIONWAY = room
{
	nam = "'B' LEVEL - COMPANIONWAY",
	dsc = [[----------------------------------------------------------------
...
FOOD_LOCKER_CORRIDOR__OUTSIDE = room
{
	nam = "FOOD LOCKER CORRIDOR - OUTSIDE",
	dsc = [[----------------------------------------------------------------
...
THE_NOSTROMO__SUNRISE = room
{
	nam = "THE NOSTROMO - SUNRISE",
	dsc = [[----------------------------------------------------------------
...
PASSAGE_NEAR_AIR_LOCK__B_LEVEL = room
{
	nam = "PASSAGE NEAR AIR LOCK - 'B' LEVEL",
	dsc = [[----------------------------------------------------------------
...
BLISTER_STAIRCASE = room
{
	nam = "BLISTER STAIRCASE",
	dsc = [[----------------------------------------------------------------
...
MAINTENANCE_LEVEL = room
{
	nam = "MAINTENANCE LEVEL",
	dsc = [[----------------------------------------------------------------
...
PASSAGEWAY__A_LEVEL = room
{
	nam = "PASSAGEWAY - 'A' LEVEL",
	dsc = [[----------------------------------------------------------------
...
FOOD_STORAGE_LOCKER_NUMBER_12 = room
{
	nam = "FOOD STORAGE LOCKER NUMBER 12",
	dsc = [[----------------------------------------------------------------
...
EQUIPMENT_MAINTENANCE_AREA = room
{
	nam = "EQUIPMENT MAINTENANCE AREA",
	dsc = [[----------------------------------------------------------------
